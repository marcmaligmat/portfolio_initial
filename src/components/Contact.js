    ...
    >
          ...
          <form id="contact-form" method="post" action="mail.php">
            <div className="row">
              ...
              <div className="col-md-12 text-center">
                <button id="cf-submit" className="btn-main" disabled>
                  Send Message
                </button>
              </div>
            </div>
      ...
      <div className="row contact-info mb-70">
        ...
        <div className="col-md-4 info-item">
          ...
          <h5>
            <a href="mailto:marcmaligmat@gmail.com">marcmaligmat@gmail.com</a>
          </h5>
        </div>
        {/*Contact Info Item*/}
        <div className="col-md-4 info-item">
